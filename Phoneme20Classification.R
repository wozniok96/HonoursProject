#Phoneme Dataset20 Minority class removed to achieve ¬5 imbalance ratio
...
save.image(file='Phoneme20MyEnvironment.RData')
dir()
load('Phoneme20MyEnvironment.RData')
