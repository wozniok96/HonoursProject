...
df <- read.csv("yeast-1_vs_7.dat", header= FALSE, stringsAsFactors = FALSE,
               skip = 12)
colnames(df)
...
ggplot(trainStd, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
ggplot(overTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
ggplot(underTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
ggplot(bothTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
ggplot(roseTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
ggplot(smoteTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
blsTrain<-BLSMOTE(trainStd[,-8], trainStd[,8],K=3,C=3,dupSize=0,method = "type1")$data
...
ggplot(blsTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
ggplot(slsTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
ggplot(adasynTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
ggplot(dbsTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
ggplot(TLsmoteTrain, aes(x=V2, y=V3, color=V8)) + geom_point(shape=16)
...
save.image(file='Yeast1vs7MyEnvironment.RData')
dir()
load('Yeast1vs7MyEnvironment.RData')
