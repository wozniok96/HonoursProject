...
df <- read.csv("segment0.dat", header= FALSE, stringsAsFactors = FALSE,
               skip = 24)
df[3]<-NULL
colnames(df)

#Change class value into integers
df$V20[df$V20 == " positive"] <- 0
df$V20[df$V20 == " negative"] <- 1
df$V20<- as.factor(df$V20)

classDist<-table(df$V20)
barplot(classDist, main="Class Distribution", 
        xlab="V20")

##unique(df$V20, incomparables = FALSE)

#Split the dataset into training and testing set
train.index <- createDataPartition(df$V20, p = .7, list = FALSE)
...
trainStd$V1<-(train$V1-mean(train$V1))/sd(train$V1)
trainStd$V2<-(train$V2-mean(train$V2))/sd(train$V2)
trainStd$V4<-(train$V4-mean(train$V4))/sd(train$V4)
trainStd$V5<-(train$V5-mean(train$V5))/sd(train$V5)
trainStd$V6<-(train$V6-mean(train$V6))/sd(train$V6)
trainStd$V7<-(train$V7-mean(train$V7))/sd(train$V7)
trainStd$V8<-(train$V8-mean(train$V8))/sd(train$V8)
trainStd$V9<-(train$V9-mean(train$V9))/sd(train$V9)
trainStd$V10<-(train$V10-mean(train$V10))/sd(train$V10)
trainStd$V11<-(train$V11-mean(train$V11))/sd(train$V11)
trainStd$V12<-(train$V12-mean(train$V12))/sd(train$V12)
trainStd$V13<-(train$V13-mean(train$V13))/sd(train$V13)
trainStd$V14<-(train$V14-mean(train$V14))/sd(train$V14)
trainStd$V15<-(train$V15-mean(train$V15))/sd(train$V15)
trainStd$V16<-(train$V16-mean(train$V16))/sd(train$V16)
trainStd$V17<-(train$V17-mean(train$V17))/sd(train$V17)
trainStd$V18<-(train$V18-mean(train$V18))/sd(train$V18)
trainStd$V19<-(train$V19-mean(train$V19))/sd(train$V19)

testStd$V1<-(test$V1-mean(train$V1))/sd(train$V1)
testStd$V2<-(test$V2-mean(train$V2))/sd(train$V2)
testStd$V4<-(test$V4-mean(train$V4))/sd(train$V4)
testStd$V5<-(test$V5-mean(train$V5))/sd(train$V5)
testStd$V6<-(test$V6-mean(train$V6))/sd(train$V6)
testStd$V7<-(test$V7-mean(train$V7))/sd(train$V7)
testStd$V8<-(test$V8-mean(train$V8))/sd(train$V8)
testStd$V9<-(test$V9-mean(train$V9))/sd(train$V9)
testStd$V10<-(test$V10-mean(train$V10))/sd(train$V10)
testStd$V11<-(test$V11-mean(train$V11))/sd(train$V11)
testStd$V12<-(test$V12-mean(train$V12))/sd(train$V12)
testStd$V13<-(test$V13-mean(train$V13))/sd(train$V13)
testStd$V14<-(test$V14-mean(train$V14))/sd(train$V14)
testStd$V15<-(test$V15-mean(train$V15))/sd(train$V15)
testStd$V16<-(test$V16-mean(train$V16))/sd(train$V16)
testStd$V17<-(test$V17-mean(train$V17))/sd(train$V17)
testStd$V18<-(test$V18-mean(train$V18))/sd(train$V18)
testStd$V19<-(test$V19-mean(train$V19))/sd(train$V19)



#Plot the original training set distribution
ggplot(trainStd, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)
...
bestSVM<- train(V20~., data = trainStd, method = "svmRadial", metric="Kappa", scale = FALSE,
                trControl=trctrl,
                tuneGrid = tuneValues)
...
bestRF <-train(V20~., data = trainStd, method = "rf", metric="Kappa",scale = FALSE,
               ntree=500,
               trControl=trctrl,
...
PredictionRF <- predict(bestRF, testStd[1:18])
summary(PredictionRF)

#Create a confusion matrix for the best model.
TabRF <- table(pred=PredictionRF, true=testStd[,19])
ResultsRF <- confusionMatrix(TabRF)
ResultsRF

sensVecRF<-c(sensVecRF, ResultsRF$byClass[[1]])
specVecRF<-c(specVecRF, ResultsRF$byClass[[2]])
F1VecRF<-c(F1VecRF, F1_Score(testStd[,19], PredictionRF))
...
weighedBestSVM<- train(V20~., data = trainStd, method = "svmRadialWeights",  metric="Kappa",scale = FALSE,
                       trControl=trctrl,
...
#Test the best model on testing data
weighedPrediction <- predict(weighedBestSVM, testStd[1:18])
summary(weighedPrediction)
weighedTab <- table(pred=weighedPrediction, true=testStd[,19])
...
weighedF1Vec<-c(weighedF1Vec, F1_Score(testStd[,19], weighedPrediction))
...
overTrain <- ovun.sample(V20~., trainStd, method="over", p=.5)$data

.
overClassDist<-table(overTrain$V20)
barplot(overClassDist, main="Class Distribution", 
        xlab="V20")

ggplot(overTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
bestOverSVM<- train(V20~., data = overTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                    trControl=trctrl,
                    tuneGrid = tuneValues)
...
#Test the best model on testing data
overPrediction <- predict(bestOverSVM, testStd[1:18])
overPrediction<- relevel(overPrediction, "0")
#Create a confusion matrix for the best model.
overTab <- table(pred=overPrediction, true=testStd[,19])
...
overF1Vec<-c(overF1Vec, F1_Score(testStd[,19], overPrediction))
...
bestOverRF <-train(V20~., data = overTrain, method = "rf", metric="Kappa",scale = FALSE,
                   ntree=500,
                   trControl=trctrl,
                   tuneGrid = tuneRfValues)
...
overPredictionRF <- predict(bestOverRF, testStd[1:18])
overPredictionRF<- relevel(overPredictionRF, "0")
summary(overPredictionRF)

#Create a confusion matrix for the best model.
overTabRF <- table(pred=overPredictionRF, true=testStd[,19])
...
overF1VecRF<-c(overF1VecRF, F1_Score(testStd[,19], overPredictionRF))
...
underTrain <- ovun.sample(V20~., trainStd, method="under", p=.5)$data

.
underClassDist<-table(underTrain$V20)
barplot(underClassDist, main="Class Distribution", 
        xlab="V20")

ggplot(underTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
bestUnderSVM <- train(V20~., data = underTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                      trControl=trctrl,
                      tuneGrid = tuneValues)
...
#Test the best model on testing data
underPrediction <- predict(bestUnderSVM, testStd[1:18])
underPrediction<- relevel(underPrediction, "0")
summary(underPrediction)

#Create a confusion matrix for the best model.
underTab <- table(pred=underPrediction, true=testStd[,19])
...
underF1Vec<-c(underF1Vec, F1_Score(testStd[,19], underPrediction))
...
bestUnderRF <-train(V20~., data = underTrain, method = "rf", metric="Kappa",scale = FALSE,
                    ntree=500,
                    trControl=trctrl,
                    tuneGrid = tuneRfValues)
...
underPredictionRF <- predict(bestUnderRF, testStd[1:18])
underPredictionRF<- relevel(underPredictionRF, "0")
summary(underPredictionRF)

#Create a confusion matrix for the best model.
underTabRF <- table(pred=underPredictionRF, true=testStd[,19])
...
underF1VecRF<-c(underF1VecRF, F1_Score(testStd[,19], underPredictionRF))
...
#Create new training set using undersampling.
bothTrain <- ovun.sample(V20~., trainStd, method="both", p=.5)$data

.
bothClassDist<-table(bothTrain$V20)
barplot(bothClassDist, main="Class Distribution", 
        xlab="V20")

ggplot(bothTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
bestBothSVM <-train(V20~., data = bothTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                    trControl=trctrl,
                    tuneGrid = tuneValues)
...
#Test the best model on testing data
bothPrediction <- predict(bestBothSVM, testStd[1:18])
bothPrediction<- relevel(bothPrediction, "0")
summary(bothPrediction)

#Create a confusion matrix for the best model.
bothTab <- table(pred=bothPrediction, true=testStd[,19])
...
bothF1Vec<-c(bothF1Vec, F1_Score(testStd[,19], bothPrediction))
...
bestBothRF <-train(V20~., data = bothTrain, method = "rf", metric="Kappa",scale = FALSE,
                   ntree=500,
                   trControl=trctrl,
                   tuneGrid = tuneRfValues)
...
bothPredictionRF <- predict(bestBothRF, testStd[1:18])
bothPredictionRF<- relevel(bothPredictionRF, "0")
summary(bothPredictionRF)

#Create a confusion matrix for the best model.
bothTabRF <- table(pred=bothPredictionRF, true=testStd[,19])
...
bothF1VecRF<-c(bothF1VecRF, F1_Score(testStd[,19], bothPredictionRF))
...
roseTrain <- ROSE(V20~., trainStd, p=0.5)$data

.
roseClassDist<-table(roseTrain$V20)
barplot(roseClassDist, main="Class Distribution", 
        xlab="V20")

ggplot(roseTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
bestRoseSVM<- train(V20~., data = roseTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                    trControl=trctrl,
                    tuneGrid = tuneValues)
...
#Test the best model on testing data
rosePrediction <- predict(bestRoseSVM, testStd[1:18])
rosePrediction<- relevel(rosePrediction, "0")
summary(rosePrediction)

#Create a confusion matrix for the best model.
roseTab <- table(pred=rosePrediction, true=testStd[,19])
...
roseF1Vec<-c(roseF1Vec, F1_Score(testStd[,19], rosePrediction))
...
bestRoseRF <-train(V20~., data = roseTrain, method = "rf", metric="Kappa",scale = FALSE,
                   ntree=500,
                   trControl=trctrl,
                   tuneGrid = tuneRfValues)
...
rosePredictionRF <- predict(bestRoseRF, testStd[1:18])
rosePredictionRF<- relevel(rosePredictionRF, "0")
summary(rosePredictionRF)

#Create a confusion matrix for the best model.
roseTabRF <- table(pred=rosePredictionRF, true=testStd[,19])
...
roseF1VecRF<-c(roseF1VecRF, F1_Score(testStd[,19], rosePredictionRF))
...
smoteTrain<-SMOTE(trainStd[,-19], trainStd[,19], K = 3, dup_size = 0)$data
colnames(smoteTrain)[19] <- "V20"
smoteTrain$V20 <- as.factor(smoteTrain$V20)
.
smoteClassDist<-table(smoteTrain$V20)
barplot(smoteClassDist, main="Class Distribution", 
        xlab="V20")

ggplot(smoteTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
bestSmoteSVM <- train(V20~., data =smoteTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                      trControl=trctrl,
                      tuneGrid = tuneValues)
bestSmoteSVM
plot(bestSmoteSVM)
...
#Test the best model on testing data
smotePrediction <- predict(bestSmoteSVM, testStd[1:18])
smotePrediction<- relevel(smotePrediction, "0")
summary(smotePrediction)

#Create a confusion matrix for the best model.
smoteTab <- table(pred=smotePrediction, true=testStd[,19])
...
smoteF1Vec<-c(smoteF1Vec, F1_Score(testStd[,19], smotePrediction))
...
bestSmoteRF <-train(V20~., data = smoteTrain, method = "rf", metric="Kappa",scale = FALSE,
                    ntree=500,
                    trControl=trctrl,
                    tuneGrid = tuneRfValues)
...
smotePredictionRF <- predict(bestSmoteRF, testStd[1:18])
smotePredictionRF<- relevel(smotePredictionRF, "0")
summary(smotePredictionRF)

#Create a confusion matrix for the best model.
smoteTabRF <- table(pred=smotePredictionRF, true=testStd[,19])
...
smoteF1VecRF<-c(smoteF1VecRF, F1_Score(testStd[,19], smotePredictionRF))
...
blsTrain<-BLSMOTE(trainStd[,-19], trainStd[,19],K=3,C=3,dupSize=0,method = "type1")$data
colnames(blsTrain)[19] <- "V20"
blsTrain$V20 <- as.factor(blsTrain$V20)
.
blsClassDist<-table(blsTrain$V20)
barplot(blsClassDist, main="Class Distribution", 
        xlab="V20")

ggplot(blsTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
bestBlsSVM <- train(V20~., data = blsTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                    trControl=trctrl,
                    tuneGrid = tuneValues)
...
#Test the best model on testing data
blsPrediction <- predict(bestBlsSVM, testStd[1:18])
blsPrediction<- relevel(blsPrediction, "0")
summary(blsPrediction)

#Create a confusion matrix for the best model.
blsTab <- table(pred=blsPrediction, true=testStd[,19])
...
blsF1Vec<-c(blsF1Vec, F1_Score(testStd[,19], blsPrediction))
...
bestBlsRF <-train(V20~., data = blsTrain, method = "rf", metric="Kappa",scale = FALSE,
                  ntree=500,
                  trControl=trctrl,
                  tuneGrid = tuneRfValues)
...
blsPredictionRF <- predict(bestBlsRF, testStd[1:18])
blsPredictionRF<- relevel(blsPredictionRF, "0")
summary(blsPredictionRF)

#Create a confusion matrix for the best model.
blsTabRF <- table(pred=blsPredictionRF, true=testStd[,19])
...
blsF1VecRF<-c(blsF1VecRF, F1_Score(testStd[,19], blsPredictionRF))
...
slsTrain<-SLS(trainStd[,-19], trainStd[,19], K = 3, dupSize = 0)$data
colnames(slsTrain)[19] <- "V20"
slsTrain$V20 <- as.factor(slsTrain$V20)
.
slsClassDist<-table(slsTrain$V20)
barplot(slsClassDist, main="Class Distribution", 
        xlab="V20")

ggplot(slsTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
bestSlsSVM<- train(V20~., data = slsTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                   trControl=trctrl,
                   tuneGrid = tuneValues)
bestSlsSVM
plot(bestSlsSVM)
...
#Test the best model on testing data
slsPrediction <- predict(bestSlsSVM, testStd[1:18])
slsPrediction<- relevel(slsPrediction, "0")
summary(slsPrediction)

#Create a confusion matrix for the best model.
slsTab <- table(pred=slsPrediction, true=testStd[,19])
...
slsF1Vec<-c(slsF1Vec, F1_Score(testStd[,19], slsPrediction))
...
bestSlsRF <-train(V20~., data = slsTrain, method = "rf", metric="Kappa",scale = FALSE,
                  ntree=500,
                  trControl=trctrl,
                  tuneGrid = tuneRfValues)
...
slsPredictionRF <- predict(bestSlsRF, testStd[1:18])
slsPredictionRF<- relevel(slsPredictionRF, "0")
summary(slsPredictionRF)

#Create a confusion matrix for the best model.
slsTabRF <- table(pred=slsPredictionRF, true=testStd[,19])
...
slsF1VecRF<-c(slsF1VecRF, F1_Score(testStd[,19], slsPredictionRF))
...
adasynTrain<-ADAS(trainStd[,-19], trainStd[,19], K = 3)$data
colnames(adasynTrain)[19] <- "V20"
adasynTrain$V20 <- as.factor(adasynTrain$V20)
.
adasynClassDist<-table(adasynTrain$V20)
barplot(adasynClassDist, main="Class Distribution", 
        xlab="V20")

ggplot(adasynTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
bestAdasynSVM <- train(V20~., data = adasynTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                       trControl=trctrl,
                       tuneGrid = tuneValues)
bestAdasynSVM
plot(bestAdasynSVM)
...
#Test the best model on testing data
adasynPrediction <- predict(bestAdasynSVM, testStd[1:18])
adasynPrediction<- relevel(adasynPrediction, "0")
summary(adasynPrediction)

#Create a confusion matrix for the best model.
adasynTab <- table(pred=adasynPrediction, true=testStd[,19])
...
adasynF1Vec<-c(adasynF1Vec, F1_Score(testStd[,19], adasynPrediction))
...
bestAdasynRF <-train(V20~., data = adasynTrain, method = "rf", metric="Kappa",scale = FALSE,
                     ntree=500,
                     trControl=trctrl,
                     tuneGrid = tuneRfValues)
...
adasynPredictionRF <- predict(bestAdasynRF, testStd[1:18])
adasynPredictionRF<- relevel(adasynPredictionRF, "0")
summary(adasynPredictionRF)

#Create a confusion matrix for the best model.
adasynTabRF <- table(pred=adasynPredictionRF, true=testStd[,19])
...
adasynF1VecRF<-c(adasynF1VecRF, F1_Score(testStd[,19], adasynPredictionRF))
...
dbsTrain<-DBSMOTE(trainStd[,-19], trainStd[,19])$data
colnames(dbsTrain)[19] <- "V20"
dbsTrain$V20 <- as.factor(dbsTrain$V20)
.
dbsClassDist<-table(dbsTrain$V20)
barplot(dbsClassDist, main="Class Distribution", 
        xlab="V20")

ggplot(dbsTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
bestDbsSVM<- train(V20~., data = dbsTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                   trControl=trctrl,
                   tuneGrid = tuneValues)
bestDbsSVM
plot(bestDbsSVM)
...
#Test the best model on testing data
dbsPrediction <- predict(bestDbsSVM, testStd[1:18])
summary(dbsPrediction)

#Create a confusion matrix for the best model.
dbsTab <- table(pred=dbsPrediction, true=testStd[,19])
...
dbsF1Vec<-c(dbsF1Vec, F1_Score(testStd[,19], dbsPrediction))
...
bestDbsRF <-train(V20~., data = dbsTrain, method = "rf", metric="Kappa",scale = FALSE,
                  ntree=500,
                  trControl=trctrl,
                  tuneGrid = tuneRfValues)
...
dbsPredictionRF <- predict(bestDbsRF, testStd[1:18])
dbsPrediction<- relevel(dbsPrediction, "0")
summary(dbsPredictionRF)

#Create a confusion matrix for the best model.
dbsTabRF <- table(pred=dbsPredictionRF, true=testStd[,19])
...
dbsF1VecRF<-c(dbsF1VecRF, F1_Score(testStd[,19], dbsPredictionRF))
...
#Create a new training set using SMOTE method
tlsmoteTrain<-SMOTE(trainStd[,-19], trainStd[,19], K = 3, dup_size = 0)$data
colnames(tlsmoteTrain)[19] <- "V20"
tlsmoteTrain$V20 <- as.factor(smoteTrain$V20)
#Apply Tomek Links removal
TLsmoteTrain <- TomekClassif(V20~., tlsmoteTrain, dist = "Euclidean", 
                             Cl = "all", rem = "both")[[1]]
.
tlsmoteClassDist<-table(TLsmoteTrain$V20)
barplot(tlsmoteClassDist, main="Class Distribution", 
        xlab="Survival Status")

ggplot(TLsmoteTrain, aes(x=V19, y=V2, color=V20)) + geom_point(shape=16)


#Find the best model using range of parameters (gridsearch)
besttlSmoteSVM <- train(V20~., data =TLsmoteTrain, method = "svmRadial", metric="Kappa",scale = FALSE,
                        trControl=trctrl,
                        tuneGrid = tuneValues)
besttlSmoteSVM
plot(besttlSmoteSVM)
...
#Test the best model on testing data
tlsmotePrediction <- predict(besttlSmoteSVM, testStd[1:18])
summary(tlsmotePrediction)

#Create a confusion matrix for the best model.
tlsmoteTab <- table(pred=tlsmotePrediction, true=testStd[,19])
...
tlsmoteF1Vec<-c(tlsmoteF1Vec, F1_Score(testStd[,19], tlsmotePrediction))
...
besttlSmoteRF <-train(V20~., data = TLsmoteTrain, method = "rf", metric="Kappa",scale = FALSE,
                      ntree=500,
                      trControl=trctrl,
                      tuneGrid = tuneRfValues)
...
tlsmotePredictionRF <- predict(besttlSmoteRF, testStd[1:18])
summary(tlsmotePredictionRF)

#Create a confusion matrix for the best model.
tlsmoteTabRF <- table(pred=tlsmotePredictionRF, true=testStd[,19])
...
tlsmoteF1VecRF<-c(tlsmoteF1VecRF, F1_Score(testStd[,19], tlsmotePredictionRF))
...
save.image(file='Segment0MyEnvironment.RData')
dir()
load('Segment0MyEnvironment.RData')
