#Phoneme Dataset10 Minority class removed to achieve ¬5 imbalance ratio
...
save.image(file='Phoneme10MyEnvironment.RData')
dir()
load('Phoneme10MyEnvironment.RData')
